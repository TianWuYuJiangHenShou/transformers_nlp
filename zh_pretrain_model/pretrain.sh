...
#rm pretrain.log
#python3 ./further_pre_training/run_pretraining.py \
#  --input_file=data/corpus.tfrecord \
#  --output_dir=state_dict/corpus_pretrain_gpu \
#  --do_train=True \
#  --do_eval=True \
#  --bert_config_file=/Users/yangyang/Desktop/berts_model/chinese_L-12_H-768_A-12/bert_config.json \
#  --init_checkpoint=/Users/yangyang/Desktop/berts_model/chinese_L-12_H-768_A-12/bert_model.ckpt \
#  --train_batch_size=32 \
#  --max_seq_length=128 \
#  --max_predictions_per_seq=20 \
