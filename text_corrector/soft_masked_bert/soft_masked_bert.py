...
#     BERT_MODEL = '../../../../../pretrain_models/bert_base_chinese/pytorch_model.bin'
#
#     config = BertConfig.from_pretrained('../../../../../pretrain_models/bert_base_chinese')
#     tokenizer = BertTokenizer.from_pretrained('../../../../../pretrain_models/bert_base_chinese/vocab.txt')
#     bert = BertModel.from_pretrained('../../../../../pretrain_models/bert_base_chinese/pytorch_model.bin', config=config)
#
#     device = 'cuda' if torch.cuda.is_available() else 'cpu'
#     model = SoftMaskedBert(argparser, tokenizer, device)
#     text = '中国的'
